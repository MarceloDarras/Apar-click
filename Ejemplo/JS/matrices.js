...
const controlContador = document.getElementById('control'); 
controlContador.style.display = 'none';
        ...
        if (botonExiste) {
          ...
          boton2.addEventListener("click", function () {
            ...
            if(confirmar == true){
                ...
                var nombreEstacionamiento = boton.innerHTML;
                console.log(nombreEstacionamiento);

                // Enviar el valor al servidor mediante AJAX
                //var xhr = new XMLHttpRequest();
                ////xhr.open("POST", "guardar_estado_estacionamientos.php", true);
                ...
                //xhr.onreadystatechange = function () {
                  ...
                  //}
                //};
                //xhr.send("estacionamiento=" + encodeURIComponent(nombreEstacionamiento));

                controlContador.style.display = '';
                iniciarTemporizador();
                if(contador.innerHTML == '00:00'){
